...
import { dataIcons } from "./data/icons.jsx";
...
import NavbarListProvider from "./providers/NavbarListProvider.jsx";
// Подключаем объект контекста основного списка
import { useNavbarListContext } from "./context/navbarListContext.js";
// Блок умного компонента SubMenuItems
const NavbarListSmart = () => {
    const { listItems } = useContext(VerticalNavbarContext);
