// Подключаем библиотеку React, хуки useContext, memo
...
// Подключаем стили элемента навигационного списка
import './NavbarListStyles.less';
// Подключаем стили кнопки добавления
import './AddItemButtonStyles.less';
// Подключаем утилитарные стили
import { dynamicPositionStyles } from './style-utils/styles.js';
...
const NavbarListView = memo(({
    ...
    const { isStretched, stretchedWidthMenu } = useContext(ToggleButtonStretchContext);
    const { listHeight, listItemActiveIndex, handleListItemActiveIndex } = useContext(VerticalNavbarContext);
    const positionOffsetUtils = dynamicPositionStyles(listHeight, stretchedWidthMenu);
