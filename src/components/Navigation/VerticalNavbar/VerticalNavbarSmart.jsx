...
import { useVerticalNavbarContext } from "./verticalNavbarContext.js";
// Подключаем провайдер вертикального списка навигации
import VerticalNavbarProvider from "./VerticalNavbarProvider.jsx";
...
const VerticalNavbarSmart = () => {
    ...
    /* Функция для показа полосы прокрутки меню */
    const handleMouseEnterShowScrolling = () => {
        setShowScrolling(true);
    };
    /* Функция для сокрытия полосы прокрутки меню */
    const handleMouseLeaveHideScrolling = () => {
    ...
    const listNavbarContext = useVerticalNavbarContext(
        ...
        handleMouseEnterShowScrolling,
        handleMouseLeaveHideScrolling
    );
