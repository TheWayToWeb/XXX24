        ...
        return (
            <>
                <InfiniteScroll
                    ...
                    next={fetchComments}
                    hasMore={hasMore}
                    loader={<NotifyLoaderView text="Загрузка..." />}
                    endMessage={<InfiniteTableDataStateNotifyIndexView />}
                >
                    <TableView
                        comments={comments}
...
InfiniteScrollTableView.propTypes = {
...
export default InfiniteScrollTableView;