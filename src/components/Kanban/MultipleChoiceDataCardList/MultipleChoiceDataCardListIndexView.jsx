...
import MultipleChoiceDataCardListView
    from "./MultipleChoiceDataCardListView.jsx";
import NotifyLoaderView from "../../Application/NotifyLoader/NotifyLoaderView.jsx";

const MultipleChoiceDataCardListIndexView = React.memo(({ itemsVisible, type, visibleCount }) => {
...
export default MultipleChoiceDataCardListIndexView;