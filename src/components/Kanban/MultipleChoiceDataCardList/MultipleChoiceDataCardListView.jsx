...
import ComplexDataCardFooterView from "../ComplexDataCardFooter/ComplexDataCardFooterView.jsx";
import { EnvelopeAt, FileX, TelephoneOutbound } from "react-bootstrap-icons";
import './MultipleChoiceDataCardListStyles.css';
import '../GeneralDataCardStyles.css';
import DataCardHeaderView from "../DataCardHeader/DataCardHeaderView.jsx";

const MultipleChoiceDataCardListView = React.memo(({ renderedTypeList, rest, visibleCount, currentItemVisibleId }) => {
...
export default MultipleChoiceDataCardListView;