...
import { translationTitleDesktopKeys } from "./config/desktopTitleTranslation.js";

// Блок презентационного компонента рабочего стола
const ColdLandingContainer = () => {
    ...
    const currentDesktopBaseKey = translationTitleDesktopKeys[currentDesktopBase];
...
export default ColdLandingContainer;