...
// Получаем провайдер производства
...
const ThreadRollingContainer = () => {

   // Получаем состояние отображения табов и функцию его изменения
...
export default ThreadRollingContainer;