...
// Подключаем менеджер маршрутов склада
...
// Получаем объект маппинга заголовка рабочего стола
...
export default InventoryAuditContainer;